...
import 'bookmarks_posts_model.dart';
export 'bookmarks_posts_model.dart';

class BookmarksPostsWidget extends StatefulWidget {
  /// parte 8 18.26
  const BookmarksPostsWidget({super.key});

  @override
  State<BookmarksPostsWidget> createState() => _BookmarksPostsWidgetState();
}

class _BookmarksPostsWidgetState extends State<BookmarksPostsWidget> {
  late BookmarksPostsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookmarksPostsModel());
