...
import 'select_photo_model.dart';
export 'select_photo_model.dart';
...
class _SelectPhotoWidgetState extends State<SelectPhotoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectPhotoModel());
